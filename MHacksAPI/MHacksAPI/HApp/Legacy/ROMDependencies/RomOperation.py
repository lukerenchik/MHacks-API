...
class RomOperation(ho.HAppOperation):
    
    def __init__(self, HAppOperationController, filename, PathManager):
        
        super().__init__()
        
        self.RomStarter = rru.RomRunner(HAppOperationController)
