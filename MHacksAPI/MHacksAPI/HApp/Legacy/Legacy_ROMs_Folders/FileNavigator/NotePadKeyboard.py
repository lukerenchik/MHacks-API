...
# =============================================================================
    ...
    def KeyF12Handler(self):
        filename = "C:/Users/derek/OneDrive/NewHaptics Shared/HapticOS/FC_GUI_API/APIv0.7-Coeus/v0.764-Coeus/testScripts/FileNavigation.txt"
        self.editor.loadTxt(filename)
        self.editor.cursor[1] = 3
        self.editor.cursorMode = 1
