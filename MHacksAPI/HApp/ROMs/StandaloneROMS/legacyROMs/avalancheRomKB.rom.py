...
def avalanchePhysics(position, cursorPosition):
    ...
    yValues =  [17 - i for i in range(0,difficulty,4)]
    pongX = position[0]
    pongY = position[1]
...
while yIncrement is not 0:
        ...
        if (currentTime) > (avalancheTimer):
            ...
            avalancheTimer += 0.1 + difficulty*0.05
            """
        ...
        """
        if difficulty < 4:
            engine.line((pong2Position[1] - 2,pong2Position[0]), (pong2Position[1] - 2,pong2Position[0] + 2))
            engine.line((pong2Position[1] - 1,pong2Position[0]), (pong2Position[1] - 1,pong2Position[0] + 2))
            engine.line((pong2Position[1],pong2Position[0]), (pong2Position[1],pong2Position[0] + 2))
        """
        if echo:    
            print(pongPosition)
